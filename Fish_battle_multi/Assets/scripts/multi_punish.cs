...
public class multi_punish : NetworkBehaviour {
	...
	public float        leftAndRightEdge = 60f;
	
	// Chance that the AppleTree will change directions
	public float        chanceToChangeDirections = 0.2f;
	
	// Rate at which Apples will be instantiated
	public float        secondsBetweenPunishDrops = 5f;
	
	// Use this for initialization
	void Start () {
		// Dropping apples every second
		InvokeRepeating( "DropPunish", 2f, secondsBetweenPunishDrops );
	}
